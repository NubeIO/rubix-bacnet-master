...
aa = [{'analogInput:1': ['objectName', 'presentValue'], 'analogInput:2': ['objectName', 'presentValue'],
       'analogInput:3': ['objectName', 'presentValue']},
      {'analogInput:4': ['objectName', 'presentValue'], 'analogInput:5': ['objectName', 'presentValue'],
      ...
      {'analogOutput:2': ['objectName', 'presentValue'], 'analogOutput:3': ['objectName', 'presentValue'],
       'analogOutput:4': ['objectName', 'presentValue']},
      {'binaryInput:1': ['objectName', 'presentValue'], 'binaryInput:2': ['objectName', 'presentValue'],
       'binaryInput:3': ['objectName', 'presentValue']},
      {'binaryInput:4': ['objectName', 'presentValue'], 'binaryInput:5': ['objectName', 'presentValue'],
       'binaryInput:6': ['objectName', 'presentValue']},
      {'binaryInput:7': ['objectName', 'presentValue'], 'binaryInput:8': ['objectName', 'presentValue'],
       'binaryInput:9': ['objectName', 'presentValue']},
      {'binaryInput:10': ['objectName', 'presentValue'], 'binaryInput:11': ['objectName', 'presentValue'],
       'binaryInput:12': ['objectName', 'presentValue']},
      {'binaryInput:13': ['objectName', 'presentValue'], 'binaryInput:14': ['objectName', 'presentValue'],
       'binaryInput:15': ['objectName', 'presentValue']},
      {'binaryInput:16': ['objectName', 'presentValue'], 'binaryOutput:1': ['objectName', 'presentValue'],
       'binaryOutput:2': ['objectName', 'presentValue']},
      {'binaryOutput:3': ['objectName', 'presentValue'], 'binaryOutput:4': ['objectName', 'presentValue'],
       'binaryOutput:5': ['objectName', 'presentValue']},
      {'binaryOutput:6': ['objectName', 'presentValue'], 'binaryOutput:7': ['objectName', 'presentValue'],
...
aa = {'address': '1001:1', 'objects': {'analogInput:1': ['objectName', 'presentValue'], 'analogInput:2': ['objectName', 'presentValue'], 'analogInput:3': ['objectName', 'presentValue']}}
print(bacnet.readMultiple('1001:1', request_dict=aa))
